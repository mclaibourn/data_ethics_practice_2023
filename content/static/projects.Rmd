...
* Week 2 (due by class Feb 2): Teams (a) start outlining purpose and policy contexts for two previously collected measures; (b) write an initial R script to download the first measure in their set and review city excel file for background and issues; and (c) begin work on request for measure not available online.
