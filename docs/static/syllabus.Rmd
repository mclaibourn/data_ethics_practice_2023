...
## Pre-Class Tasks
Once you have read the syllabus and have R, RStudio, and the tidyverse set up on your computer ([instructions for installing R, RStudio, and all the tidyverse packages](../install/)) OR you have created an [Posit/RStudio Cloud Free account](https://rstudio.cloud/plans/free), email me at [mclaibourn@virginia.edu](mailto:mclaibourn@virginia.edu) with
